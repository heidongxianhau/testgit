...
class YOLO_Kmeans:
    ...
    def xml2boxes(self,path=None):
        import glob,os
        import xml.etree.ElementTree as ET
        if not path:
            path ="/home/deeplearning/NEW/chen/dataset/SeaShips(7000)/Annotations"
        xml_list = glob.glob(os.path.join(path,"*.xml"))
        all_box = []
        for label_xml in xml_list:
            ...
            for obj in objects:
                ...
                all_box.append([int(xmax)-int(xmin),int(ymax)-int(ymin)])
